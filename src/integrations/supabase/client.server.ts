...
function createSupabaseAdminClient() {
  ...
  if (!process.env["SUPABASE_SERVICE_ROLE_KEY"] && !process.env["SUPABASE_SECRET_KEY"]) {
    console.warn(
      "[Supabase Server Admin] SUPABASE_SERVICE_ROLE_KEY is not set. Using publishable/anon key as fallback. Note: Signed URLs and administrative bypass require SUPABASE_SERVICE_ROLE_KEY in .env.",
    );
  }
