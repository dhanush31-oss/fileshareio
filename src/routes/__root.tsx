...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Vaultdrop" },
      { property: "og:title", content: "Vaultdrop — Crypto File Escrow" },
      {
...
function RootComponent() {
  ...
  useEffect(() => {
    // Actively remove any Lovable bookmark / badge widgets dynamically injected into the DOM
