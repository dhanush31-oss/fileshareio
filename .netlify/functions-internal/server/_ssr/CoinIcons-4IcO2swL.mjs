...
import { i as cn } from "./AppShell-CQNRbcL4.mjs";
import { t as Root } from "../_libs/radix-ui__react-label.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CoinIcons-4IcO2swL.js
...
function EthIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M16 4L15.8 4.7V20.2L16 20.4L23 16.3L16 4Z",
				fill: "#627EEA"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M16 4L9 16.3L16 20.4V4Z",
				fill: "#8DA2FB"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M16 21.6L15.9 21.7V27.7L16 28L23 17.5L16 21.6Z",
				fill: "#627EEA"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M16 28V21.6L9 17.5L16 28Z",
				fill: "#8DA2FB"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M16 20.4L23 16.3L16 13.1V20.4Z",
				fill: "#4560C9"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M9 16.3L16 20.4V13.1L9 16.3Z",
				fill: "#627EEA"
			})
		]
	});
}
function UsdtIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function UsdcIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function SolIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M8.5 21.5L11.5 18.5H23.5L20.5 21.5H8.5Z",
				fill: "url(#sol-g1)"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M8.5 10.5L11.5 7.5H23.5L20.5 10.5H8.5Z",
				fill: "url(#sol-g2)"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M20.5 16L23.5 13H11.5L8.5 16H20.5Z",
				fill: "url(#sol-g3)"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { stopColor: "#00FFA3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", {
						offset: "1",
						stopColor: "#DC1FFF"
					})]
				}),
...
function BnbIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function BtcIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function MaticIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function CustomCoinIcon({ className = "size-5" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		className,
		viewBox: "0 0 32 32",
		fill: "none",
...
function getCoinLogo(symbol, className = "size-5 shrink-0") {
	const s = (symbol || "").toUpperCase();
	if (s === "ETH") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EthIcon, { className });
	if (s === "USDT") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UsdtIcon, { className });
	if (s === "USDC") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UsdcIcon, { className });
	if (s === "SOL") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SolIcon, { className });
	if (s === "BNB") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BnbIcon, { className });
	if (s === "BTC") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BtcIcon, { className });
	if (s === "MATIC" || s === "POL") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MaticIcon, { className });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CustomCoinIcon, { className });
}
//#endregion
export { getCoinLogo as n, Label as t };
