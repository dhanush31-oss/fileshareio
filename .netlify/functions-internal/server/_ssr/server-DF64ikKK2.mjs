...
import { n as createMiddleware, r as __exportAll } from "./server-DF64ikKK.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C1YSB5yP.mjs");
...
var manifest = {
	"04472eb5da27876f4cb89b75160de45bd7e7800a340f21bf44738dcc217f0c88": {
		functionName: "uploadPaymentProofFile_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"1458b7a46906e07674fdc4a92bab2f2853f921ea4243184209740d77e466723a": {
		functionName: "getProofUrl_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"208f9caabfc0aab8f5a34d636ea1f9e972ad7705a5bb6204fb06de9a85bd0eaf": {
		functionName: "reviewPaymentProof_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"2bf149bdf650b09dbf053d5a12456f74e6f4f5d907e4f63dd10c44191c321595": {
		functionName: "getRoomProofs_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"5becd1a02839619a0fc04722e7106c6e3f1003a08bdb092b3e76683db0af1955": {
		functionName: "listRoomFiles_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"60d11190bfc705b246fa86164446a0fb36196cd7a2b3c45ed62a565099046392": {
		functionName: "listMyRooms_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"63b1321fc8bd1789f446cf2b232ab2f0737fce6e188051f5140e7cd9de58349a": {
		functionName: "joinRoom_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"80d38ff4a34dc69449f7babe686f2da22a903e5e1f8f8083882a4c4c443d2435": {
		functionName: "createRoom_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"8824c6215b3178a65f0c49e42533741b3b4d50da8d9bcf82054c950e2f41b81a": {
		functionName: "markNotificationsRead_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"919039427615aa5a3782869a51438ff3c837e7a95842db7708a24003645b6f57": {
		functionName: "adminListRooms_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"95d949ab8916eaed895c154a8f2c349a7835c5d22bbdf008daf371eca5c46861": {
		functionName: "submitPaymentProof_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"a80e28bca324701c786214f986107592b7cd9eaeb0410f94736022d2ddf3af97": {
		functionName: "adminGetFileUrl_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"be187d66f625dcd3b904296e880d0e2ff62fa908a09c257369fb677873e8ea30": {
		functionName: "getDownloadUrl_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"bef65e9413261bafbd068a4852226a253995b9b261f531277cff26b0d348b833": {
		functionName: "listNotifications_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"c25bca671b743c44576c03ec7330f11f135acd9038ea0eb759d0cfee330f15ff": {
		functionName: "uploadEscrowFile_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	},
	"faedd7fdf1881b934bc2130d91d2fa913cfd0549e535fd087bbc31fdd6decbac": {
		functionName: "recheckProofOnChain_createServerFn_handler",
		importer: () => import("./escrow.functions-B9ACB3Zc.mjs")
	}
};
...
var innerCreateCsrfMiddleware = (opts = {}) => {
	return (typeof createMiddleware === "function" ? createMiddleware : () => ({
		server: (h) => h,
		client: (h) => h
	}))().server(async (ctx) => {
		const csrfCtx = ctx;
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DngNvJgu.mjs").then((n) => n.t),
		import("./start-1ZrcW_LM.mjs"),
